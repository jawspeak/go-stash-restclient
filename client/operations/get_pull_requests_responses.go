...
func (o *GetPullRequestsReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 404:
		var result GetPullRequestsNotFound
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, NewAPIError("getPullRequestsNotFound", &result, response.Code())
...
func (o *GetPullRequestsOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
